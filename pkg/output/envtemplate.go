...
func (d *EnvTemplateDest) Write(resp *op.SecretResponse) error {
	...
	tmpl, err := template.New("env-template").Parse(`# This file was generated by optruck.{{if .Account}}
#   - 1password account: {{.Account}}{{end}}{{if .VaultName}}
#   - 1password vault: {{.VaultName}}{{end}}
# To restore, run the following command:
#   $ op inject -i {{.Dest.GetBasename}} -o .env
